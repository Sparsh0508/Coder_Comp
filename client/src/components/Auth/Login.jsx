    ...
    return (
        <div className="flex justify-center items-center min-h-[calc(100vh-40px)] px-4">
            ...
            >
                ...
                <p className="text-[#a0a0b0] text-center mb-8 text-lg">Sign in to continue your journey</p>
                ...
                <div className="mt-6 text-center text-[#a0a0b0] text-sm">
                    ...
                    <Link to="/signup" className="text-[#3a7bd5] font-semibold ml-1 transition-colors hover:text-[#00d2ff] hover:underline">Create one</Link>
                </div>
            </motion.div>
        </div>
    );
